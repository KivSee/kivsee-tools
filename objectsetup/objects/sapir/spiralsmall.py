val = {
        ...
        {
            "name": "subout1",
            "pixels": [{"index": 721}] + [dict({"index": n}) for n in range(520, 560)]
        },
        {
            "name": "subout2",
        ...
        {
            "name": "subout5",
            "pixels": [dict({"index": n}) for n in range(629, 638)] + [dict({"index": n}) for n in range(690, 703)]
        },
        {
            "name": "subout6",
            "pixels": [dict({"index": n}) for n in range(638, 648)] + [dict({"index": n}) for n in range(679, 690)]
        },
        {
            "name": "subout7",
             "pixels": [dict({"index": n}) for n in range(648, 653)] + [dict({"index": n}) for n in range(672, 679)]
        },
        {
            "name": "subout8",
            "pixels": [dict({"index": n}) for n in range(653, 659)] + [dict({"index": n}) for n in range(667, 672)]
        },
        {
            "name": "subout9",
